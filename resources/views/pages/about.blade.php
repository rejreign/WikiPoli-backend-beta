        ...
        <div class="about">
          <h4 class="display-4 text-center text-primary">About Us</h4>
            ...
            <div class="mt-5">
              ...
              First, <a href="signup.html" class="words">Sign Up</a> as a User on WikiPoli, you could sign up using your Google account or Facebook account and if you don't have one you could just input in your data.
              
              Now, <a href="login.html" class="words">Log In</a> in order to view and interact with recent posts as well as creating posts.
