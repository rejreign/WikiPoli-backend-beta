        ...
        <div class="row">
            ...
            <div class="col-md-10 ">
                ...
                <form class="form-horizontal" method="POST" action="#">
                    <h1 class="cover-heading"><a href="{{ url('/posts') }}"><img class="img-logo"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input id="Name" name="full_name" type="text" value="{{$user->full_name}}"
                ...
                <a href="{{ url('/user_profile') }}" class="btn btn-lg btn-primary btn-blue btn-block mt-3">Go Back To Profile</a><br>
            </div>
